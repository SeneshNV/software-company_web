  ...
  return (
    <section id="team" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="absolute inset-0 bg-primary/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="flex space-x-4">
                    <a
                      ...
                      className="w-10 h-10 bg-background text-primary rounded-full flex items-center justify-center hover:bg-secondary transition-colors duration-200"
                    >
        ...
        {/* Join Team CTA */}
        <Card className="text-center mt-16 p-8">
          ...
          <Button size="lg" className="hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
            View Open Positions
          </Button>
        </Card>
      </div>
